...
drop table ORDERSHIP cascade constraints;
...
(
ShipID int generated by default on null as identity,
Company varchar(20), 
primary key (ShipID)
); 
...
insert into Products values ('1030', '0001', '0004', 'Racer TV'); 
insert into Products values ('1042', '0002', '0002', 'iPhone 6s'); 
insert into Products values ('1043', '0002', '0002', 'iPhone 11'); 
insert into Products values ('1044', '0002', '0003', 'Macbook 12');
insert into Products values ('2002', '0003', '0002', 'Galaxy 10'); 
insert into Products values ('2003', '0003', '0002', 'SS A8'); 
insert into Products values ('2042', '0004', '0003', 'HP 13 Laptop'); 
insert into Products values ('2045', '0004', '0003', 'ASUS 5 Laptop');
insert into Products values ('2050', '0007', '0004', 'Nitro Acer 5 Laptop'); 
insert into Products values ('2340', '0005', '0001', 'Base Camera');
insert into Products values ('2342', '0005', '0001', 'Film Camera'); 
insert into Products values ('3080', null, '0006', 'Mech Keyboard'); 
insert into Products values ('3090', null, '0006', 'Light up Keyboard'); 
insert into Products values ('3100', null, '0005', 'Logitech USB'); 
insert into Products values ('5000', '0006', '0007', 'Mario Kart'); 
insert into Products values ('5001', '0006', '0007', 'Legend of Zelda'); 
insert into Products values ('5002', '0006', '0007', 'Smash Ultimate'); 
insert into Products values ('5003', '0008', '0007', 'Spyro'); 
insert into Products values ('1031', '0008', '0004', '56in TV'); 
...
insert into RestockProd values (2, '3090', '01', 20); 
insert into RestockProd values (2, '2050', '01', 50); 
...
insert into Orders values (null, 1, '07', 'Complete', 185, date '2022-04-24');
insert into OrderProd values (1, '5000', '07', 1); 
insert into OrderProd values (1, '5001', '07', 1); 
insert into OrderProd values (1, '5002', '07', 1); 
insert into OrderProd values (1, '5003', '07', 1); 
insert into Orders values (null, 1, '08', 'Complete', 1150, date '2022-04-30');
insert into OrderProd values (2, '2002', '08', 1);
...
-- orders of a cerain time period: 
select * 
from Orders natural join OrderProd natural join Products
where Odate between '23-APR-22' and '26-APR-22';

-- orders of a certain product (PID)
select * 
from Orders natural join OrderProd natural join Products
where PID = '5000';

-- orders of a certain grouping (category name)
select * 
from Orders natural join OrderProd natural join Products natural join Categories
where CategoryName = 'Video Games';

-- orders of a certain inventory
select * 
from Orders natural join OrderProd natural join Products
where InvID = '07';

-- orders of a certain region 
select * 
from Orders natural join OrderProd natural join Products
where InvID in (select InvID from Addresses natural join Stores where Region = 'Southwest') 
or InvID in (select InvID from Addresses natural join Warehouses where Region = 'Southwest');
